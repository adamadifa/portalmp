...
<form action="{{ route('tujuanangkutan.store') }}" method="POST" id="formCreateTujuan" novalidate>
    @csrf

    <div class="mb-3 fl-group">
        <input type="text" id="kode_tujuan" name="kode_tujuan" required maxlength="3" placeholder=" " class="fl-input uppercase font-mono">
        <label class="fl-label" for="kode_tujuan">Kode Tujuan <span class="fl-req">*</span></label>
    </div>

    <div class="mb-3 fl-group">
        <input type="text" id="tujuan" name="tujuan" required maxlength="30" placeholder=" " class="fl-input uppercase">
        <label class="fl-label" for="tujuan">Nama Tujuan <span class="fl-req">*</span></label>
    </div>

    <div class="mb-4 fl-group">
        <input type="text" id="tarif" name="tarif" required placeholder=" " class="fl-input font-semibold text-right">
