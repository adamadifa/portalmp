...
<form action="{{ route('angkutan.update', Crypt::encrypt($angkutan->kode_angkutan)) }}" method="POST" id="formEditAngkutan" novalidate>
    @csrf
    @method('PUT')

    {{-- Row 1: Kode (Disabled) & Nama Angkutan --}}
    <div class="grid grid-cols-2 gap-3 mb-3">
        <div class="fl-group">
            <input type="text" id="kode_angkutan" name="kode_angkutan" disabled value="{{ $angkutan->kode_angkutan }}" placeholder=" " class="fl-input">
            <label class="fl-label" for="kode_angkutan">Kode Angkutan</label>
        </div>
        <div class="fl-group">
            <input type="text" id="nama_angkutan" name="nama_angkutan" required maxlength="50" value="{{ $angkutan->nama_angkutan }}" placeholder=" " class="fl-input uppercase">
    ...
    <div class="mb-4 fl-group">
        <input type="text" id="keterangan" name="keterangan" maxlength="30" value="{{ $angkutan->keterangan }}" placeholder=" " class="fl-input">
