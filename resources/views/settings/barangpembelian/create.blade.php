...
<form action="{{ route('barangpembelian.store') }}" method="POST" id="formCreateBarang" novalidate>
    @csrf

    {{-- Row 1: Kode Barang & Nama Barang --}}
    <div class="grid grid-cols-2 gap-3 mb-3">
        <div class="fl-group">
            <input type="text" id="kode_barang" name="kode_barang" required maxlength="7" placeholder=" " class="fl-input uppercase">
            <label class="fl-label" for="kode_barang">Kode Barang <span class="fl-req">*</span></label>
        </div>
        <div class="fl-group">
            <input type="text" id="nama_barang" name="nama_barang" required maxlength="100" placeholder=" " class="fl-input uppercase">
    ...
    <div class="grid grid-cols-2 gap-3 mb-3">
        <div class="fl-group">
            <input type="text" id="satuan" name="satuan" required maxlength="20" placeholder=" " class="fl-input uppercase">
