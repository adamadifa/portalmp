        ...
        <table class="w-full text-sm text-left">
            <tbody>
                <tr class="border-b border-gray-200/50">
                    <th class="py-2 font-bold text-gray-500 w-1/3">No. Dokumen</th>
                    <td class="py-2 text-gray-800 font-semibold">{{ $lainnya->no_mutasi }}</td>
                </tr>
                <tr class="border-b border-gray-200/50">
                    <th class="py-2 font-bold text-gray-500">Tanggal</th>
                    <td class="py-2 text-gray-800 font-medium">{{ DateToIndo($lainnya->tanggal) }}</td>
                </tr>
                <tr class="border-b border-gray-200/50">
                    <th class="py-2 font-bold text-gray-500">Tipe Mutasi</th>
                    <td class="py-2">
                        @if ($lainnya->in_out === 'I')
                ...
                <tr>
                    <th class="py-2 font-bold text-gray-500">Keterangan</th>
                    <td class="py-2 text-gray-700 text-xs font-medium">{{ $lainnya->keterangan }}</td>
                </tr>
            </tbody>
        </table>
    </div>
