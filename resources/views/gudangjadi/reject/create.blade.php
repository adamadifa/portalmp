...
<form action="{{ route('rejectgudangjadi.store') }}" method="POST" id="formcreateReject" class="space-y-4" novalidate>
    @csrf

    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div class="fl-group">
            <input type="text" name="no_mutasi" id="no_mutasi" readonly placeholder=" " class="fl-input" />
            <label class="fl-label" for="no_mutasi">No. Reject (Otomatis)</label>
        </div>
        <div class="fl-group">
