        ...
        <table class="w-full text-sm text-left">
            <tbody>
                <tr class="border-b border-gray-200/50">
                    <th class="py-2 font-bold text-gray-500 w-1/3">No. Repack</th>
                    <td class="py-2 text-gray-800 font-semibold">{{ $repack->no_mutasi }}</td>
                </tr>
                <tr>
                    <th class="py-2 font-bold text-gray-500">Tanggal</th>
                    <td class="py-2 text-gray-800 font-medium">{{ DateToIndo($repack->tanggal) }}</td>
                </tr>
            </tbody>
        </table>
    </div>
