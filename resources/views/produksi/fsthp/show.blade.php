<div class="space-y-6">
    <div class="bg-gray-50 p-4 rounded-xl border border-gray-100 space-y-2">
        <div class="flex justify-between text-xs">
            <span class="text-gray-500 font-medium">No. FSTHP:</span>
            <span class="text-gray-900 font-bold">{{ $fsthp->no_mutasi }}</span>
        </div>
        <div class="flex justify-between text-xs">
            <span class="text-gray-500 font-medium">Tanggal:</span>
            <span class="text-gray-900 font-semibold">{{ date('d-m-Y', strtotime($fsthp->tanggal_mutasi)) }}</span>
        </div>
        <div class="flex justify-between text-xs">
            <span class="text-gray-500 font-medium">Unit:</span>
            <span class="text-gray-900 font-semibold">{{ $fsthp->unit }}</span>
        </div>
    </div>
