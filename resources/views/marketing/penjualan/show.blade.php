                    ...
                    @else
                        <form action="{{ route('penjualanmarketing.storebayar', Crypt::encrypt($penjualan->no_bukti)) }}" method="POST" class="space-y-3.5 pt-1">
                            ...
                            <div class="c-fl-group">
                                ...
                                <input type="number" step="0.01" name="jumlah" id="jumlah_bayar_input" max="{{ $sisa_tagihan }}" min="0.01" placeholder="Contoh: 50000" class="fi font-mono font-bold text-gray-900" required autocomplete="off">
