<form action="{{ route('laporanmarketing.cetakpenjualan') }}" method="POST" id="formLapPenjualan" target="_blank" class="space-y-3.5 pt-1">
    @csrf
    ...
    <div class="c-fl-group">
        ...
        <select name="kode_pelanggan" id="kode_pelanggan_penjualan" class="select2Pelanggan">
    ...
    <div class="grid grid-cols-2 gap-4">
        <div class="c-fl-group">
            ...
            <input type="text" name="dari" id="dari_penjualan" class="fi flatpickr-date" placeholder="Pilih Tanggal" required autocomplete="off" />
            <label for="dari_penjualan" class="c-fl-label">Dari Tanggal *</label>
        </div>
        ...
        <div class="c-fl-group">
            ...
            <input type="text" name="sampai" id="sampai_penjualan" class="fi flatpickr-date" placeholder="Pilih Tanggal" required autocomplete="off" />
            <label for="sampai_penjualan" class="c-fl-label">Sampai Tanggal *</label>
        </div>
    </div>
