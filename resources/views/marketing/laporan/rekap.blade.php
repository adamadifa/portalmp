<form action="{{ route('laporanmarketing.cetakrekap') }}" method="POST" id="formLapRekapPenjualan" target="_blank" class="space-y-3.5 pt-1">
    ...
    <div class="c-fl-group">
        ...
        <select name="kode_pelanggan" id="kode_pelanggan_rekappenjualan" class="select2Pelanggan">
            <option value="">Semua Pelanggan</option>
            @foreach ($pelanggan as $d)
                <option value="{{ $d->kode_pelanggan }}">{{ strtoupper($d->nama_pelanggan) }}</option>
            @endforeach
        </select>
        <label for="kode_pelanggan_rekappenjualan" class="c-fl-label">Pelanggan</label>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4">
        <div class="c-fl-group">
            ...
            <input type="text" name="dari" id="dari_rekappenjualan" class="fi flatpickr-date" placeholder="Pilih Tanggal" required autocomplete="off" />
            <label for="dari_rekappenjualan" class="c-fl-label">Dari Tanggal *</label>
        </div>
        ...
        <div class="c-fl-group">
            ...
            <input type="text" name="sampai" id="sampai_rekappenjualan" class="fi flatpickr-date" placeholder="Pilih Tanggal" required autocomplete="off" />
            <label for="sampai_rekappenjualan" class="c-fl-label">Sampai Tanggal *</label>
        </div>
    </div>
