<form action="{{ route('barangmasukgudanglogistik.store') }}" method="post" id="formcreatebarangmasukgudanglogistik" class="space-y-4">
    @csrf
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="c-fl-group">
            ...
            <input type="text" name="no_bukti" id="no_bukti" class="fi" placeholder="No. Bukti Pemasukan" autocomplete="off" />
