<form action="{{ route('opgudanglogistik.store') }}" method="post" id="formcreateopnamegudanglogistik" class="space-y-4">
    @csrf
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
        ...
        <div class="md:col-span-3">
            <button type="button" id="getsaldo" class="w-full inline-flex items-center justify-center px-4 py-2.5 text-xs font-semibold text-white bg-[#294C9A] hover:bg-[#1E3A70] rounded-xl transition shadow-sm gap-1.5 h-[38px]">
...
<script>
$(function() {
    const formCreate = $("#formcreateopnamegudanglogistik");
