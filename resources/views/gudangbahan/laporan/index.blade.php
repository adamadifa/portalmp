<x-app-layout>
    ...
    <!-- Header & Subtitle -->
    <div class="mb-6">
        <h2 class="text-2xl font-semibold text-gray-900 tracking-tight">Laporan Gudang Bahan</h2>
        <p class="text-sm text-gray-500 mt-1">Mengelola dan mencetak laporan mutasi serta persediaan barang di gudang bahan.</p>
    </div>
