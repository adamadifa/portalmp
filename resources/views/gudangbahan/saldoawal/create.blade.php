...
<form action="{{ route('sagudangbahan.store') }}" method="POST" id="formCreatesaldoawal" class="space-y-4" novalidate>
    @csrf
        ...
        <div class="overflow-x-auto max-h-[40vh]">
            <table class="w-full text-left border-collapse">
                ...
                <tbody id="loaddetailsaldo" class="text-sm divide-y divide-gray-100">
                    <tr>
                        <td colspan="5" class="py-6 px-4 text-center text-xs text-gray-400">Silahkan pilih bulan & tahun lalu tekan Get Saldo.</td>
                    </tr>
                </tbody>
            </table>
        </div>
