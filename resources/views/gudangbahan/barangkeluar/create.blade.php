...
<form action="{{ route('barangkeluargudangbahan.store') }}" method="POST" id="formcreateBarangkeluargudangbahan" novalidate class="pt-2">
    @csrf
    ...
    <div class="grid grid-cols-3 gap-3 mb-4 pt-2">
        <div class="c-fl-group">
            ...
            <input type="text" name="no_bukti" id="no_bukti" class="fi bg-gray-100/60" placeholder="Auto" readonly autocomplete="off" />
    ...
    <div class="grid grid-cols-1 gap-3 mb-4">
        ...
        <div class="c-fl-group" id="keterangan-section">
            ...
            <input type="text" name="keterangan_barang_keluar" id="keterangan_barang_keluar" class="fi" placeholder="Keterangan pengeluaran..." autocomplete="off" />
