<form action="{{ route('laporanpembelian.cetakauh') }}" method="POST" id="formLapAuh" target="_blank" class="space-y-6 pt-1">
    @csrf
    ...
    <div class="grid grid-cols-2 gap-4">
        <div class="c-fl-group">
            ...
            <input type="text" name="dari" id="dari_auh" class="fi flatpickr-date" placeholder="Pilih Tanggal" required autocomplete="off" />
            <label for="dari_auh" class="c-fl-label">Dari Tanggal *</label>
        </div>
        ...
        <div class="c-fl-group">
            ...
            <input type="text" name="sampai" id="sampai_auh" class="fi flatpickr-date" placeholder="Pilih Tanggal" required autocomplete="off" />
            <label for="sampai_auh" class="c-fl-label">Sampai Tanggal *</label>
        </div>
    </div>
