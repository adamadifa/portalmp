<x-app-layout>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-semibold text-gray-900 tracking-tight">Buat Kontra Bon</h2>
            <p class="text-sm text-gray-500 mt-1">Buat data kontra bon pembelian baru.</p>
        </div>
    </div>

    <form action="{{ route('kontrabonpmb.store') }}" method="POST" id="formKontrabon" class="space-y-6">
        @csrf
            ...
            <div class="lg:col-span-4 space-y-4">
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
                    <div class="c-fl-group">
                        ...
                        <input type="text" name="no_kontrabon" id="no_kontrabon" class="fi bg-gray-50 cursor-not-allowed" placeholder="AUTO" disabled />
                    ...
                    <div class="c-fl-group">
                        ...
                        <input type="text" name="no_dokumen" id="no_dokumen" class="fi" placeholder="No. Dokumen" autocomplete="off" />
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
                    ...
                    <div class="overflow-x-auto rounded-xl border border-gray-200 shadow-sm mt-3">
                        <table class="w-full text-xs text-left">
                            ...
                            <tbody id="loadpembelian" class="divide-y divide-gray-100 bg-white"></tbody>
