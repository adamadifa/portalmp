<form action="#" id="formPotongan" class="space-y-4">
    <div class="c-fl-group">
        <span class="c-fl-icon">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
        </span>
        <input type="text" name="keterangan_potongan" id="keterangan_potongan" class="fi" placeholder="Keterangan" autocomplete="off" />
    ...
    <div class="c-fl-group">
        ...
        <input type="text" name="jumlah_potongan" id="jumlah_potongan" class="fi number-separator text-right" placeholder="0" autocomplete="off" />
    ...
    <div class="c-fl-group">
        ...
        <input type="text" name="harga_potongan" id="harga_potongan" class="fi number-separator text-right" placeholder="0" autocomplete="off" />
    ...
    <div class="c-fl-group">
        ...
        <input type="text" name="total_potongan" id="total_potongan" class="fi bg-gray-50 text-right" placeholder="0" readonly />
